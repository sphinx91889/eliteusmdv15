      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="bg-gray-50 p-8 rounded-xl mb-16">
            <h2 className="text-3xl font-bold mb-8 text-center text-secondary">Wellness Services We Support</h2>
            <div className="grid md:grid-cols-3 gap-6">
              {[
                {
                  title: "IV Therapy",
                  description: "Medical oversight for vitamin and nutrient infusion therapies"
                },
                {
                  title: "Hormone Optimization",
                  description: "Supervision of hormone replacement and optimization programs"
                },
                {
                  title: "Regenerative Medicine",
                  description: "Oversight of regenerative treatments and therapies"
                },
                {
                  title: "Nutritional Medicine",
                  description: "Medical guidance for advanced nutritional protocols"
                },
                {
                  title: "Stress Management",
                  description: "Integration of medical and holistic stress reduction approaches"
                },
                {
                  title: "Preventive Care",
                  description: "Development of comprehensive preventive health programs"
                }
              ].map((service, index) => (
