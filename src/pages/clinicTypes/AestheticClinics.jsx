      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="bg-gray-50 p-8 rounded-xl mb-16">
            <h2 className="text-3xl font-bold mb-8 text-center text-secondary">Services We Support</h2>
            <div className="grid md:grid-cols-3 gap-6">
              {[
                {
                  title: "Injectable Treatments",
                  description: "Expert oversight for Botox, dermal fillers, and other injectable procedures"
                },
                {
                  title: "Laser Treatments",
                  description: "Medical supervision for various laser procedures and skin treatments"
                },
                {
                  title: "Skin Rejuvenation",
                  description: "Oversight for chemical peels, microdermabrasion, and other skin services"
                },
                {
                  title: "Body Contouring",
                  description: "Medical direction for non-invasive body sculpting treatments"
                },
                {
                  title: "Medical Grade Skincare",
                  description: "Supervision of medical-grade product dispensing and treatments"
                },
                {
                  title: "Advanced Aesthetics",
                  description: "Oversight for cutting-edge aesthetic procedures and technologies"
                }
              ].map((service, index) => (
